...
const form=useRef();
 ...
 const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_008q9dm', 'template_mwoje0o', form.current, {
        publicKey: 'zBr8Uj5KJDF1t0Es2',
      })
      .then(
        () => {
           setName('');
  ...
  return (
    <div>
        ...
        <form className='flex flex-col text-white gap-4 'ref={form} onSubmit={sendEmail}>
            ...
            <input name='from_email' type='email' placeholder='Your Email' require className='h-12 rounded-lg bg-lightBrown px-2'
             value={email}
