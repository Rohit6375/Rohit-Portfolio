...
const NavbarMain = () => {
  ...
  <div className="w-full max-w-[95%] sm:max-w-[70%] lg:max-w-[1200px] mx-auto bg-black border border-orange rounded-full flex items-center justify-between px-4 py-3">
